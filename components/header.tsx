  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/"
          className="group flex gap-1 rounded-full px-2 py-2 cursor-pointer items-center bg-card hover:bg-muted border border-border"
        >
          <Cross
            size={14}
      ...
      <div className="flex items-center gap-2" suppressHydrationWarning>
        ...
        <span
          ...
          className="group hover:cursor-pointer rounded-full px-2 py-2 bg-card hover:bg-muted border border-border"
        >
          <TextSearch size={14} className=" text-foreground/80" />
        </span>
