  ...
  return (
    ...
    >
      ...
      <div className='flex items-center gap-2'>
        <Link href="/" className="group flex gap-1 bg-gradient-to-tr from-card/55 via-card/70 to-card/45 backdrop-blur-sm drop-shadow-sm shadow-inner shadow-foreground/5 border border-border/80 rounded-full px-2 py-2 cursor-pointer items-center">
          <Cross
            size={18}
