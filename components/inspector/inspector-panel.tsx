  ...
  return (
    <TooltipProvider>
      <div className="h-full flex flex-col overflow-hidden bg-background md:px-4 md:pt-14 md:pb-4">
        <div className="flex flex-col h-full bg-secondary dark:bg-card/70 boring-dark:bg-card/70 text-secondary-foreground dark:text-foreground/90 md:rounded-xl md:border overflow-hidden">
