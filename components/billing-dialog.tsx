...
export const STRIPE_BILLING_URL =
  'https://billing.stripe.com/p/login/test_7sYcN572Ia4v1mEcVMbEA00'
      ...
      <DialogContent className="max-w-md w-[95%] p-0 overflow-hidden rounded-2xl border border-border">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <span className="text-foreground font-medium">Stripe</span>, a
            trusted payment platform. You can upgrade, downgrade, or cancel your
            subscription directly from the Stripe Customer Portal.
          </p>
