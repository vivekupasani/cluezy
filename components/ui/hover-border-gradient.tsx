...
>) {
  ...
  const movingMap: Record<Direction, string> = {
    ...
    BOTTOM:
      'radial-gradient(20.7% 50% at 50% 100%, var(--primary) 0%, rgba(163, 0, 76, 0) 100%)',
    RIGHT:
      'radial-gradient(16.2% 41.199999999999996% at 100% 50%, var(--primary) 0%, rgba(163, 0, 76, 0) 100%)'
  }

  const highlight =
    'radial-gradient(75% 181.15942028985506% at 50% 50%, var(--ring) 0%, rgba(219, 39, 119, 0) 100%)'
