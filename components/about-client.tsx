...
export default function AboutClient() {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "min-h-svh h-full overflow-y-auto CustomScrollbar bg-background",
                    open && !isMobile
                ...
                <div className="max-w-3xl mx-auto px-6 py-6 md:py-4">
                    <header className="mb-6 text-center space-y-4">
                        ...
                        <div className="flex flex-col justify-start items-start">
                            ...
                            <p className="text-foreground text-sm md:text-base max-w-md text-start">
                    ...
                    <main className="text-foreground/90 leading-7 md:leading-8">
                        <section className="space-y-6">
                            <p className="text-md text-foreground">
                                ...
                                Cluezy is an{" "}
                                <span className="font-medium italic underline decoration-primary/30 underline-offset-4">
                                    agentic research engine
                                </span>{" "}
                                designed to make information discovery smarter, faster, and more intuitive.
                            </p>
                            ...
                            <p>
                                ...
                                for everyone. We combine advanced AI models,
                                deep contextual understanding, and real-time
                                search capabilities to deliver accurate,
                                meaningful, and reliable answers—not just a list
                                of links.
                            </p>
                        </section>
                        ...
                        <section className="grid gap-8 md:grid-cols-2 mt-10">
                            <div className="p-6 rounded-2xl border border-border/50 bg-secondary/10 space-y-3">
                                ...
                                <p className="text-sm">
                                    Redefining how people interact with
                                    information through innovation, user-centric
                            ...
                            <div className="p-6 rounded-2xl border border-border/50 bg-secondary/10 space-y-3">
                                ...
                                <p className="text-sm">
                                    We're shaped by the belief that technology
                                    should empower curiosity, creativity, and
                                    professional growth.
                                </p>
                            </div>
                        </section>
                        ...
                        <p className="text-center pt-8">
                            We’re not just building a tool; we’re building a
                            smarter way to think, search, and learn.
                        </p>
                    </main>

                    <footer className="mt-20 md:mt-1 pt-12 flex flex-col items-center gap-6">
                        ...
                        <p className="text-[10px] md:text-xs text-foreground tracking-widest uppercase">
