...
export function ConnectorsProvider({
  ...
  const fetchConnections = async () => {
    ...
    try {
      ...
      setLoading(true)
      const connectionsFromLocalStorage = getConnectionsFromLocalStorage()
      if (connectionsFromLocalStorage) {
        setConnections(connectionsFromLocalStorage)
        setLoading(false)
        fetchInProgressRef.current = false
      }
      ...
      setConnections(data)
      setConnectionsToLocalStorage(data)
  ...
  function setConnectionsToLocalStorage(apps: Connection[]) {
    localStorage.setItem('connections', JSON.stringify(apps))
  }
