...
export const AuthContext = React.createContext<{
  ...
  setUserPlanDetails: React.Dispatch<
    React.SetStateAction<UserPlanDetailsProps | null>
  >
} | null>(null)
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const [userPlanDetails, setUserPlanDetails] =
    React.useState<UserPlanDetailsProps | null>(null)
  ...
  const getUserPlanData = async () => {
    ...
    try {
      const { getUserPlan, saveUserPlanDetails } = await import(
        '@/lib/actions/user-premium'
      )
