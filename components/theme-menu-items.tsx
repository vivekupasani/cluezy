...
export function ThemeMenuItems() {
  ...
  return (
    <>
      ...
      >
        <Sun className="mr-2 h-4 w-4 text-foreground" />
        <span className="text-foreground font-medium">T3 Light</span>
      </DropdownMenuItem>
      <DropdownMenuItem
      ...
      >
        <Moon className="mr-2 h-4 w-4 text-foreground" />
        <span className="text-foreground font-medium">T3 Dark</span>
      </DropdownMenuItem>
    </>
  )
}
...
export function ArtifactThemeMenuItems() {
  ...
  return (
    <>
      <DropdownMenuItem
        onClick={() => setTheme('boring-light')}
        className={`cursor-pointer ${theme === 'boring-light' ? 'bg-accent text-accent-foreground mb-1' : 'my-0'}`}
      >
      ...
      <DropdownMenuItem
        onClick={() => setTheme('boring-dark')}
        className={`cursor-pointer ${theme === 'boring-dark' ? 'bg-accent text-accent-foreground my-1' : 'my-0'}`}
      >
      ...
      {/* <DropdownMenuItem
        onClick={() => setTheme('system')}
        className={`cursor-pointer ${theme === 'system' ? 'bg-accent text-accent-foreground my-1' : 'my-0'}`}
      >
      ...
      <DropdownMenuItem
        onClick={() => setTheme('light')}
        className={`cursor-pointer ${theme === 'light' ? 'bg-accent text-accent-foreground my-1' : 'my-0'}`}
      >
        <Sun className="mr-2 h-3 w-3 text-foreground" />
      ...
      <DropdownMenuItem
        onClick={() => setTheme('dark')}
        className={`cursor-pointer ${theme === 'dark' ? 'bg-accent text-accent-foreground my-1' : 'my-0'}`}
      >
        <Moon className="mr-2 h-3 w-3 text-foreground" />
        <span className="text-foreground font-medium text-xs">T3 Dark</span>
      </DropdownMenuItem>
    </>
  )
}
