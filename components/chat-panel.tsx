      ...
      >
        ...
        {showScrollToBottomButton && messages.length > 0 && (
          <Button
            ...
            variant="outline"
            size="icon"
            className="absolute -top-10 right-2 sm:right-4 z-20 size-7 sm:size-8 rounded-full bg-gradient-to-tr from-card/55 via-card/70 to-card/45 backdrop-blur-sm drop-shadow-sm shadow-inner shadow-foreground/5"
