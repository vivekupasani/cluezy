  ...
  return (
    <div
      className={cn(
        ...
        'pr-2 sm:px-0', // Responsive padding
        messages.length > 0
          ? 'sticky bottom-0 pb-6 sm:pb-4 px-4'
          : 'px-4 sm:px-6'
      )}
    >
      {messages.length === 0 && (
      ...
      >
        ...
        <div className="relative flex flex-col w-full bg-card rounded-2xl sm:rounded-3xl">
          <Textarea
            ref={inputRef}
            name="input"
            rows={2}
            ...
            className="resize-none w-full min-h-14 bg-transparent border-0 p-3 sm:p-4 text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
            onChange={e => {
              handleInputChange(e)
          ...
          <div className="flex items-center justify-between p-2 sm:p-3">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              {input.length > 0 && (
                <Button
                  ...
                  className={cn(
                    ...
                    'rounded-full size-9 sm:size-10'
                  )}
                  disabled={
                ...
                >
                  {!isEnhancePromptLoading ? (
                    <Edit2Icon size={18} className="sm:size-5" />
                  ) : (
                    <Loader size={18} className="sm:size-5 animate-spin duration-500" />
                  )}
                </Button>
              )}
              ...
              <Button
                ...
                className={cn(
                  isLoading && 'animate-pulse',
                  'rounded-full size-9 sm:size-10 bg-primary text-primary-foreground'
                )}
                disabled={
                  (input.length === 0 && !isLoading) ||
                  isToolInvocationInProgress()
