      ...
      <div className="max-w-2xl mx-auto px-4 py-10 pb-20">
        ...
        <div className="mt-10 text-center">
          ...
          <p className="mt-2 text-xs pb-1 bg-clip-text text-transparent bg-gradient-to-tr from-foreground/90 to-foreground/60">
            A comprehensive guide to using Cluezy&apos;s agentic research
            capabilities
          </p>
        </div>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="web-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Find information on current
                    events, news, and general topics.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you need broad internet
                    results.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "Latest AI developments", "Explain quantum
                    entanglement"
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="academic-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Locate peer-reviewed research
                    papers and studies.
                  </p>
                  <p>
                    <strong>When to use:</strong> For scientific or scholarly
                    research.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "CRISPR gene editing research", "Climate change
                    marine studies"
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="video-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Discover YouTube videos by topic.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you want video tutorials
                    or reviews.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "Italian pasta cooking tutorials", "Tech reviews
                    on YouTube"
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="youtube-analysis">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Extract transcript, timestamps,
                    and metadata from a YouTube URL.
                  </p>
                  <p>
                    <strong>When to use:</strong> When analyzing a specific
                    YouTube video.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Example: "Analyze this video:
          ...
          <section>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="retrieve">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Read and extract content from a
                    given URL.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you want summaries or
                    insights from articles.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "Summarize this blog", "Extract key points from
                    this article"
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="product-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Identify products and find similar
                    items.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you provide a product or
                    image URL.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
          ...
          <section>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="pdf-summarize">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Generate a concise summary of an
                    uploaded PDF.
                  </p>
                  <p>
                    <strong>When to use:</strong> When the document is long and
              ...
              <AccordionItem value="pdf-chat">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Ask questions and have a
                    conversation with the PDF content.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you need specific answers
                    from the document.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "What does section 3 explain?", "Summarize page
                    12"
                  </div>
                </AccordionContent>
              </AccordionItem>
          ...
          <section>
            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="pdf-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Locate PDF documents.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you explicitly want PDFs.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
                    Examples: "Machine learning PDFs", "Technical documentation
                    PDFs"
                  </div>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="doc-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Locate Word documents.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you need DOC/DOCX files.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
              ...
              <AccordionItem value="ppt-search">
                ...
                <AccordionContent className="space-y-2 text-sm text-foreground/80 leading-relaxed">
                  <p>
                    <strong>Purpose:</strong> Locate PowerPoint presentations.
                  </p>
                  <p>
                    <strong>When to use:</strong> When you need slides.
                  </p>
                  <div className="bg-muted/50 p-3 rounded-md text-xs font-mono border border-border/50">
