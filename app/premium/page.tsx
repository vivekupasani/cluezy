  ...
  return (
    <div className="h-screen w-full flex flex-col items-center px-4 sm:px-6 py-6 sm:py-14 overflow-y-auto CustomScrollbar">
      ...
      <div className="text-center max-w-xl mb-8 sm:mb-14 px-2">
        ...
        <span className="border border-border bg-muted text-muted-foreground rounded-full px-2 text-xs sm:text-sm font-mono flex items-center justify-center w-fit mx-auto mb-2">
          select your plan
        </span>
